...
import mpmath
import numpy as np
from domain_coloring_base_typed import visualize_function, ComplexNumber, save_plot
...
def create_comparison_grid() -> Figure:
    ...
    fig.suptitle(
        "exp(1/z²) Essential Singularity - Multi-Zoom Comparison", fontsize=16, y=0.95
    )
