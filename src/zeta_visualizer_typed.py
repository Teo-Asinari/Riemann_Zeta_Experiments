...
class RiemannZetaVisualizer:
    ...
    def zeta_function(
        self, 
        s: Union[ComplexNumber, ComplexArray]
    ...
    def _finalize_plot(
        ...
        ax.set_title(
            "Magnitude of Riemann Zeta Function |ζ(s)|", 
            fontsize=14
        )
        ax.legend()
    ...
    def visualize_magnitude(
        ...
        # Create plot
        fig, ax, im = self._create_base_plot(
            magnitude, real_range, imag_range
        )
...
def save_visualization(fig: Figure, filename: str = "zeta_magnitude.png") -> None:
    ...
    full_path = ("/home/tasinari/my_repos/"
                "Riemann_Zeta_Experiments/output/" + filename)
